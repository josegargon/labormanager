...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/home/josema/Proyectos/labormanager/Symfony/app/cache/prod/annotations', false);
    }
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'labormanager', 'host' => '127.0.0.1', 'port' => NULL, 'user' => 'root', 'password' => 'n0stradamus', 'charset' => 'UTF8', 'driver' => 'pdo_mysql', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_7d31cb7926f24e95820e6f9bbc7b7f3b');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_7d31cb7926f24e95820e6f9bbc7b7f3b');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_7d31cb7926f24e95820e6f9bbc7b7f3b');
        ...
        $d->setProxyDir('/home/josema/Proyectos/labormanager/Symfony/app/cache/prod/doctrine/orm/Proxies');
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('/home/josema/Proyectos/labormanager/Symfony/app/logs/prod.log', 100, true);
    }
    ...
    {
        return $this->services['security.secure_random'] = new \Symfony\Component\Security\Core\Util\SecureRandom('/home/josema/Proyectos/labormanager/Symfony/app/cache/prod/secure_random.seed', $this->get('monolog.logger.security', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('/home/josema/Proyectos/labormanager/Symfony/app/cache/prod/sessions');
    }
    protected function getSession_Storage_FilesystemService()
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/home/josema/Proyectos/labormanager/Symfony/app/cache/prod/sessions');
    }
    ...
    {
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'exception_controller' => 'twig.controller.exception:showAction', 'autoescape_service' => NULL, 'autoescape_service_method' => NULL, 'cache' => '/home/josema/Proyectos/labormanager/Symfony/app/cache/prod/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/home/josema/Proyectos/labormanager/Symfony/app/../web', false);
    }
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/home/josema/Proyectos/labormanager/Symfony/app/cache/prod');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/home/josema/Proyectos/labormanager/Symfony/app/cache/prod',
            ...
            'session.save_path' => '/home/josema/Proyectos/labormanager/Symfony/app/cache/prod/sessions',
            ...
            'router.resource' => '/home/josema/Proyectos/labormanager/Symfony/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/home/josema/Proyectos/labormanager/Symfony/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.default.memory.path' => '/home/josema/Proyectos/labormanager/Symfony/app/cache/prod/swiftmailer/spool/default',
            ...
            'assetic.cache_dir' => '/home/josema/Proyectos/labormanager/Symfony/app/cache/prod/assetic',
            ...
            'doctrine.orm.proxy_dir' => '/home/josema/Proyectos/labormanager/Symfony/app/cache/prod/doctrine/orm/Proxies',
