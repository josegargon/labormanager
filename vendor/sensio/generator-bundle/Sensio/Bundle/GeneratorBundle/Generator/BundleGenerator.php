...
class BundleGenerator extends Generator
{
    ...
    public function generate($namespace, $bundle, $dir, $format, $structure)
    {
        ...
        $this->renderFile('bundle/FrontendController.php.twig', $dir.'/Controller/FrontendController.php', $parameters);
        $this->renderFile('bundle/FrontendControllerTest.php.twig', $dir.'/Tests/Controller/FrontendControllerTest.php', $parameters);
